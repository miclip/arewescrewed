...
const BASE_SCENARIO: Omit<ScenarioParams, 'laborReductionPct' | 'aiCostPerWorkerYear' | 'aiCostDeclineRate' | 'marginRetentionPct' | 'dividendPayoutRatio' | 'rampYears' | 'revenueGrowthRate' | 'supplyChainCostPct'> = {
	yearsForward: 30,
	baseYear: 2025,
